...
if [ "$COMMAND" == "download" ]; then
  ...
  for SAMPLE in $SAMPLES; do
    ...
    if [[ $FORMAT == F* ]]; then
      ...
      cat /data/bioinfo/scratch/breakseq_fastqs/2022-02-21_ancientGenomes/${SAMPLE}/* >> selected_regions.fastq
      ...
      for REGION in $REGIONS; do
        ...
        BAM_FILE="/data/bioinfo/scratch/breakseq_fastq/2022-02-21_ancientGenomes/${SAMPLE}/*"
