...
if [ "$COMMAND" == "download" ]; then
  ...
  for SAMPLE in $SAMPLES; do
    ...
    if [[ $FORMAT == F* ]]; then
      ...
      cat /20210325_breakseq/${OUTDIR}/01_download/2022-02-21_ancientGenomes/${SAMPLE}/*.fastq >> selected_regions.fastq
      ...
      for REGION in $REGIONS; do
        ...
        BAM_FILE="/20210325_breakseq/${OUTDIR}/01_download/2022-02-21_ancientGenomes/${SAMPLE}/*"
