...
open MULTI, "<$out_dir/Output/Insertions/$ARGV[0].Multiple_Retrotransposon_Insertions_Format2.txt";
open OUT_WH, ">$out_dir/Output/Insertions/$ARGV[0].WholeMultiple_Retrotransposon_Insertions.txt"; #frangments can be put together
open OUT_WH2, ">$out_dir/Output/Insertions/$ARGV[0].WholeMultiple_Retrotransposon_Insertions_Format2.txt";
open OUT_WH3, ">$out_dir/Output/Insertions/$ARGV[0].WholeMultiple_Retrotransposon_Insertions_Format3.txt";
open OUT_FR, ">$out_dir/Output/Insertions/$ARGV[0].FragmentMultiple_Retrotransposon_Insertions.txt"; #frangments cannot be put together
open OUT_FR2, ">$out_dir/Output/Insertions/$ARGV[0].FragmentMultiple_Retrotransposon_Insertions_Format2.txt";
open OUT_FR3, ">$out_dir/Output/Insertions/$ARGV[0].FragmentMultiple_Retrotransposon_Insertions_Format3.txt";
