...
open FLANKINGSEQ, "<$ARGV[0]"; #Modified06072009.FragmentMultiple_Retrotransposon_Insertions.txt
open MICROHOMOLOGY, ">$out_dir/Output/Insertions/$ARGV[1].MicroHomologyFragMultiple_Retrotransposon_Insertions.txt";
open MICROHOMOLOGY2, ">$out_dir/Output/Insertions/$ARGV[1].MicroHomologyFragMultiple_Retrotransposon_Insertions_Format2.txt";
open NOTSURE, ">$out_dir/Output/Insertions/$ARGV[1].UNSURE_6_Multiple_Retrotransposon_Insertions.txt";
open NOTSURE2, ">$out_dir/Output/Insertions/$ARGV[1].UNSURE_6_Multiple_Retrotransposon_Insertions_Format2.txt";

print MICROHOMOLOGY "ChrNo.\tStart\tEnd\tLeftFlankingSequence\tRightFlankingSequence\tName\tInsertedSeq\tID\tClass\tNames\tnmhNo.\tnmhSeq\tpolyAonCorrStrand\tStrandElement\tTSD\tClassLabel\tRTnames\tstrandPolyAtail\n";
print NOTSURE "ChrNo.\tStart\tEnd\tLeftFlankingSequence\tRightFlankingSequence\tName\tInsertedSeq\tID\tClass\tNames\tnmhNo.\tnmhSeq\tpolyAonCorrStrand\tStrandElement\tTSD\tClassLabel\tRTnames\tstrandPolyAtail\n";
print MICROHOMOLOGY2 "ChrNo.\tStart\tEnd\tLeftFlankingSequence\tRightFlankingSequence\tName\tInsertedSeq\tID\tClass\tNames\tnmhNo.\tnmhSeq\tpolyAonCorrStrand\tStrandElement\tTSD\tClassLabel\tRTnames\tstrandPolyAtail\n";
print NOTSURE2 "ChrNo.\tStart\tEnd\tLeftFlankingSequence\tRightFlankingSequence\tName\tInsertedSeq\tID\tClass\tNames\tnmhNo.\tnmhSeq\tpolyAonCorrStrand\tStrandElement\tTSD\tClassLabel\tRTnames\tstrandPolyAtail\n";
<FLANKINGSEQ>;
while($myline = <FLANKINGSEQ>){
	...
	$SV_Size = length($fields[$InsertedSeq]);
