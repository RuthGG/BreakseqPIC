...
NAME="1kgp_highcov_static_v2.4.1.300_v38"
...
# To override:
	...
	# 1 download -> we can override it by just having a FASTQ variable, even with 0 value override
		...
		READ_FASTQS="/data/bioinfo/common/breakseq_data/2022-10-20_1kgp_highcov_static_v2.4.1.300_v38"
	# 2 breakseq
...
# individuals to test"
SAMPLESLIST="data/use/1KGP_30x_data/static_dataset_list.txt"
SAMPLESFILE="data/use/1KGP_30x_data/pathIndex.txt"
